...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%;">
     ...
     <asp:TemplateField HeaderText="View Task">
         <ItemTemplate>
              <a href="../employee/task/<%# Eval("username") %>/<%# Eval("doc_path") %>" target="_blank" >View</a>
         </ItemTemplate>
     </asp:TemplateField>
         ...
         <ItemTemplate>
              <img src='../employee/photos/<%# Eval("photo") %>' width="100px" height="100px" style="border: thin solid #FF9900" />
                ...
                <asp:SqlDataSource ID="SqlDataGetData" runat="server" 
                    ...
                    SelectCommand="SELECT Registration.empid, Registration.empname, Registration.username, Registration.photo, Task.taskid, Task.task, Task.doc_path FROM Registration INNER JOIN Task ON Registration.username = Task.username WHERE (Task.user_status = 'Done') AND (Task.admin_status = 'Pending')">
                </asp:SqlDataSource>
                </asp:Panel>
            </td>
        </tr>
