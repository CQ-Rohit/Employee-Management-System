...
public partial class admin_NewEmp : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd.CommandText = "insert into Registration(empid,empname,dob,gender,address,emailid,mobile,username,pwd,photo,status,company,groupname)values(@empid,@empname,@dob,@gender,@address,@emailid,@mobile,@username,@pwd,@photo,@status,@company,@groupname)";
