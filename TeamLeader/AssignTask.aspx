<%@ Page Title="" Language="C#" MasterPageFile="~/TeamLeader/TeamMasterPage.master" AutoEventWireup="true" CodeFile="AssignTask.aspx.cs" Inherits="TeamLeader_AssignTask" %>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataGetGroup" runat="server" 
                    ...
                    SelectCommand="SELECT distinct [groupname] FROM [Registration]">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr valign="top">
