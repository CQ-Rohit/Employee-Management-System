...
public partial class TeamLeader_AssignTask : System.Web.UI.Page
{
    SqlConnection cn;
    SqlCommand cmd;
    SqlCommand cmd1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //SqlDataGetGroup.SelectCommand = "SELECT distinct [groupname] FROM [Registration]";
    ...
    protected void saveData()
    {
        ...
        {
            cmd.CommandText = "insert into Task(taskid,task,date1,username,user_status,admin_status) values (" + txtid.Text + ",'" + txttask.Text + "','" + d + "','" + uid + "','Pending','Pending' )";
            cmd.Connection = cn;
            cmd.ExecuteNonQuery();
        }
        cn.Close();
